...
import java.io.*;
    ...
    g.addVertex("Sovabazar Sutanuti");
    ...
    g.addVertex("Tollygunge");
    g.addVertex("New Alipore");
    g.addVertex("Majerhat");

    g.addEdge("Dum Dum", "Belgachhia", 3);
    g.addEdge("Belgachhia", "Shyambazar", 2);
    g.addEdge("Shyambazar", "Sovabazar Sutanuti", 1);
    g.addEdge("Sovabazar Sutanuti", "Girish Park", 1);
    g.addEdge("Girish Park", "Mahatma Gandhi Road", 1);
    g.addEdge("Mahatma Gandhi Road", "Central", 1);
    g.addEdge("Central", "Chandni Chowk", 1);
    g.addEdge("Chandni Chowk", "Esplanade", 1);
    g.addEdge("Esplanade", "Park Street", 1);
    g.addEdge("Park Street", "Maidan", 1);
    g.addEdge("Maidan", "Rabindra Sadan", 1);
    g.addEdge("Rabindra Sadan", "Netaji Bhavan", 1);
    g.addEdge("Netaji Bhavan", "Jatin Das Park", 1);
    g.addEdge("Jatin Das Park", "Kalighat", 2);
    g.addEdge("Kalighat", "Rabindra Sarobar", 2);
    g.addEdge("Rabindra Sarobar", "Tollygunge", 2);
    g.addEdge("Tollygunge", "New Alipore", 3);
    g.addEdge("New Alipore", "Majerhat", 2);
    g.addEdge("Majerhat", "Kalighat", 2);
    g.addEdge("Kalighat", "Jatin Das Park", 2);
    g.addEdge("Jatin Das Park", "Netaji Bhavan", 1);
    g.addEdge("Netaji Bhavan", "Rabindra Sadan", 1);
    g.addEdge("Rabindra Sadan", "Maidan", 1);
    g.addEdge("Maidan", "Park Street", 1);
    g.addEdge("Park Street", "Esplanade", 1);
    g.addEdge("Esplanade", "Chandni Chowk", 1);
    g.addEdge("Chandni Chowk", "Central", 1);
    g.addEdge("Central", "Mahatma Gandhi Road", 1);
    g.addEdge("Mahatma Gandhi Road", "Girish Park", 1);
    g.addEdge("Girish Park", "Shyambazar", 1);
	g.addEdge("Shyambazar", "Belgachhia", 2);
    g.addEdge("Belgachhia", "Dum Dum", 3);
